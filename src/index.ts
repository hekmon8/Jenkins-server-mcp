...
const JENKINS_URL = process.env.JENKINS_URL || 'http://sohoci.rd.tp-link.net/jenkins';
const JENKINS_USER = process.env.JENKINS_USER || 'huhonghua';
const JENKINS_TOKEN = process.env.JENKINS_TOKEN || '9e89dcf7b460e67df6a228244f59db25';
